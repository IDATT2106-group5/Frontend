  ...
  <div class="min-h-screen bg-gray-100 font-sans">
    ...
    <section class="bg-white p-6 flex flex-col md:flex-row gap-6">
      ...
      <div class="bg-gray-50 p-4 border rounded max-w-4xl mx-auto">
        ...
        <p class="text-sm">
          Store nedbørsmengder har ført til alvorlige oversvømmelser i Trøndelag. Vannstanden er
          kritisk høy, særlig i Trondheim. Veier er stengt og flere distrikter isolert. Myndighetene
          har erklært katastrofetilstand i de hardest rammede områdene. Situasjonen kan forverre seg
          grunnet fortsatt kraftig regn.
        </p>
      </div>

      <!-- Map Placeholder -->
      <div
        class="w-full md:w-1/3 h-64 bg-gray-300 rounded flex items-center justify-center text-gray-700"
      >
        Kart
      </div>
    </section>
