...
/**
 * Mock data representing news items for fallback purposes.
 */
...
const mockNewsData = [
  {
    ...
    content:
      'Et alvorlig stormvarsel er utstedt for sørlige regioner. Vennligst hold deg innendørs.',
  ...
  },
  {
    ...
    content:
      'Mannskap jobber med å gjenopprette strømmen i østlige distrikter etter gårsdagens storm.',
  ...
  },
  {
    ...
    content:
      'Flomvarselet for Trøndelag er oppgradert til rødt nivå. Evakuering anbefales i lavtliggende områder.',
  ...
  },
  {
    ...
    content:
      'E6 er stengt mellom Trondheim og Stjørdal grunnet oversvømmelse. Bruk alternative ruter.',
  ...
  },
  {
    ...
    content:
      'Alle innbyggere må koke drikkevann i minst ett minutt før bruk grunnet mulig forurensning.',
  ...
  },
  {
    ...
    content:
      'Midlertidige boenheter er nå tilgjengelige for familier berørt av flommen. Registrer deg ved rådhuset.',
  ...
  },
  {
    ...
    content:
      'Ekstra vaksinasjonstilbud mot vannbårne sykdommer er nå tilgjengelig ved alle helsestasjoner.',
  ...
  },
  {
    ...
    content:
      'Frivillige kan melde seg til ryddearbeid i sentrum. Oppmøte ved rådhuset kl. 08:00 daglig.',
  ...
  },
  {
    ...
    content:
      'Begrenset togtrafikk mellom Oslo og Trondheim grunnet skader på jernbanelinjen. Forsinkelser må påregnes.',
    source: 'Bane NOR',
  },
  {
    id: 12,
    ...
    content:
      'Krisesenteret vil være åpent døgnet rundt frem til 20. november for de som trenger assistanse.',
    source: 'Kommunal Krisestab',
  },
  {
    id: 13,
    ...
    content:
      'Gratis psykologtjenester tilbys for de som er berørt av katastrofen. Ring 800 12 345 for avtale.',
  ...
  },
  {
    ...
    content:
      'E6 er nå delvis gjenåpnet for trafikk, med redusert hastighet og ett kjørefelt i hver retning.',
    source: 'Statens Vegvesen',
  },
  {
    id: 15,
    ...
    content:
      'Søknader om økonomisk katastrofestøtte kan nå leveres online eller ved servicekontoret.',
    source: 'NAV',
  },
  {
    id: 16,
    ...
    content:
      'Gjenåpning av skoler utsettes til 27. november for å sikre trygge forhold for elever og ansatte.',
    source: 'Utdanningsdirektoratet',
  },
  {
    id: 17,
    ...
    content:
      'Dårlig luftkvalitet forventes i berørte områder. Personer med luftveisplager bør holde seg innendørs.',
  ...
  },
  {
    ...
    content:
      'Normal vannforsyning er gjenopprettet i sentrale områder. Kokevarselet gjelder fortsatt.',
    source: 'Kommunalt Vannverk',
  },
  {
    id: 19,
    ...
    content:
      'Gratis barnepasstjenester tilbys for familier involvert i gjenoppbyggingsarbeid. Registrer deg ved rådhuset.',
  ...
  },
  {
    ...
    content:
      'Skredalarm er aktivert for fjellområdene rundt Ålesund. Evakuering pågår i utsatte områder.',
  ...
  },
  {
    ...
    content:
      'Nødtilstanden er offisielt avsluttet. Gjenoppbyggingsarbeidet fortsetter i berørte områder.',
    source: 'Fylkesmannen',
  },
]

/**
 * Defines a Pinia store for managing news items.
 */
export const useNewsStore = defineStore('news', {
  ...
  state: () => ({
    ...
    loading: false, // Indicates if news is being fetched.
    error: null, // Stores any error message during fetching.
  }),
  ...
  /**
   * Actions for modifying the state or performing asynchronous operations.
   */
  actions: {
    /**
    ...
    /**
     * Fetches news items from an API or uses mock data as a fallback.
     * Updates the state with the fetched data and handles errors.
     */
    async fetchNews() {
      this.loading = true
      this.error = null
